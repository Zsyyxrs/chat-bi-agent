...
HAPPY_PATH = [
    ("q001", "查询上海分行（BR_CITY_0006）所有高净值客户的客户 ID、姓名和客户等级。",
     {"dim_customer"}),
    ("q002", "统计有多少个产品分类为 '理财' 且风险等级为 'MEDIUM'？",
     {"dim_product"}),
    ("q003", "查询 2026 年 5 月 14 日当天发生的所有交易，返回交易 ID、账户 ID、交易金额和交易类型。",
     {"fct_transaction"}),
    ("q004", "找出 2026 年 2 月 15-23 日期间，交易渠道为 ATM 或 COUNTER 的现金支取交易。返回交易日期、账户 ID、金额和交易渠道。",
     {"fct_transaction"}),
    ("q006", "统计杭州（BR_CITY_0000）和南京（BR_CITY_0002）分行的 MASS 层客户数量。",
     {"dim_customer"}),
    ("q007", "按产品分类统计各类产品的平均风险等级评分，并按评分从高到低排序。",
     {"dim_product"}),
]
